            ...
            <div className="p-4 bg-slate-50/50 border-b border-slate-100 shrink-0">
              <form action={addMenu} className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                ...
                <div className="flex gap-2 items-center">
                  <label className="flex items-center gap-1 text-sm text-slate-600 font-medium whitespace-nowrap bg-white px-2 py-2.5 rounded-lg border border-slate-200 cursor-pointer">
                    <input type="checkbox" name="is_today_special" value="true" className="w-4 h-4 text-amber-500" /> 日替わり
                  </label>
                  <button type="submit" className="bg-amber-500 hover:bg-amber-600 text-white px-4 py-2.5 rounded-lg transition flex items-center justify-center shrink-0 w-full sm:w-auto">
                    <Plus size={18} />
                  </button>
                </div>
              </form>
